...
<div class="min-h-[80vh] flex items-center justify-center p-4">
    <div class="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md border border-gray-100">
        ...
        <form method="POST" use:enhance class="space-y-6">
            ...
            <div>
                <label for="mobile" class="block text-sm font-bold text-gray-700 mb-1">Mobile Number</label>
                <input
                    type="tel"
                    id="mobile"
                    name="mobile"
            ...
            {#if form?.success}
                <div class="p-4 bg-green-50 text-green-600 rounded-xl text-sm font-medium border border-green-100">
                    Registration successful! You can now <a href="/login" class="underline">login</a>.
                </div>
            {/if}
